            ...
            <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
              <div class="flex flex-col items-center border-t pt-6">
                ...
                <nav class="flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-2 md:gap-6 mb-4">
                  ...
                  <a href="#" class="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Realisations</a>
                  <a href="#" class="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Web-Harmony</a>
                  <a href="#" class="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Article</a>
              ...
              <div class="text-gray-400 text-sm text-center py-8">© 2021 - All rights reserved build with Laravel - @Copyright By Spyros Zaboukis & Agence-Web-Harmony.com.</div>
            </footer>
          </div>
